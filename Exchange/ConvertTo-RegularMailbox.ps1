<#
.SYNOPSIS
    Script to Convert a Shared Mailbox into a Regular Mailbox
.DESCRIPTION
    This script will convert a shared mailbox into a regular mailbox using the ExoPowershellModule.
.NOTES
...
Set-Mailbox $user -Type:Regular -Verbose
